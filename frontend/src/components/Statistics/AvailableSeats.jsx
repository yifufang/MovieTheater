...
export default function AvailableSeats() {
  ...
  return (
    <section class="text-gray-600 body-font" ref={componentRef}>
      <div>
        <h1 class="text-2xl font-bold text-left py-2 px-5">
          Seats Configuration
        </h1>
      </div>
      <div class="container px-5 py-3 mx-auto">
        <div class="flex flex-wrap -m-4">
          <div class="p-4 lg:w-1/4">
            <SeatsCapacity
              theater_id={"a"}
              number_of_seats={seats.a.number_of_seats}
              number_of_available_seats={seats.a.number_of_available_seats}
            />
          </div>
          <div class="p-4 lg:w-1/4">
            <SeatsCapacity
              theater_id={"b"}
              number_of_seats={seats.b.number_of_seats}
              number_of_available_seats={seats.b.number_of_available_seats}
            />
          </div>
          <div class="p-4 lg:w-1/4">
            <SeatsCapacity
              theater_id={"c"}
              number_of_seats={seats.c.number_of_seats}
              number_of_available_seats={seats.c.number_of_available_seats}
            />
          </div>
          <div class="p-4 lg:w-1/4">
            <SeatsCapacity
              theater_id={"d"}
              number_of_seats={seats.d.number_of_seats}
              number_of_available_seats={seats.d.number_of_available_seats}
            />
          </div>
        </div>
      </div>
